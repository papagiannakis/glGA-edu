...
void			displayGui(){
	...
	ImGui::Begin("FrequencyClamping Control");
	ImGui::SetWindowSize(ImVec2(200, 200), ImGuiSetCond_Once);
	ImGui::SetWindowPos(ImVec2(10, 220), ImGuiSetCond_Once);

	ImGui::ColorEdit3("Checkboard Color0", (float*)&Color0);
	ImGui::Separator();
	ImGui::ColorEdit3("Checkboard Color1", (float*)&Color1);
	ImGui::Separator();
	ImGui::SliderFloat("Frequency", &Frequency, 0.1, 100.0, "%.2f");
