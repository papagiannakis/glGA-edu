...
void HDRI_frame::SetTextureUnit(int t)
{
 ...
 switch (t)
 {
	...
	case 5:
		this->TextureUnitEnum = GL_TEXTURE5;
		break; 
	case 6:
			this->TextureUnitEnum = GL_TEXTURE6;
			break;
	case 7:
		this->TextureUnitEnum = GL_TEXTURE7;
		break;
	case 8:
		this->TextureUnitEnum = GL_TEXTURE8;
		break;
	case 9:
		this->TextureUnitEnum = GL_TEXTURE9;
		break;
     default:
